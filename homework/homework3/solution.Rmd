...
a) 0% chance of rolling a sum of 1 with two dice - the only possible results are from 2-12.

b) There are 36 possible combinations for 2 dice.  A five can be rolled with the following pairs - (1,4), (4,1), (2,3), (3,2)
...
results <- c(0,5,10,30)
samp <- sample(results,size=10000,replace=T,prob=odds)
mean(samp)
```
